...
## Installation
### [Follow step-by-step tutorial here](Documents/InstallationTutorial.md)
...
```
cd existing_repo
git remote add origin https://gitlab.com/Hypnot/vector-database.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Hypnot/vector-database/-/settings/integrations)
